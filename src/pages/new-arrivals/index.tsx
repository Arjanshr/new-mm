...
import { getNewArrivalProduct } from "@/redux/thunks/productThunk";
...
const NewArrivalProducts = () => {
  ...
  useEffect(() => {
    dispatch(getNewArrivalProduct({ page: 1, pageSize: 10000 }));
  }, [dispatch]);
